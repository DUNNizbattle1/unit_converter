 ...
 *Meter - метр = 10 дециметров = 100 сантиметров
 *Decimeter - дециметр = 10 сантиметров = 100 миллиметров
 *Centimetre - сантиметр = 10 миллиметров
 *Millimeter - миллиметр = 1000 миктрон
 *Micron - микрон*/
